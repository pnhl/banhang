  ...
  return (
    <footer className="site-page-footer">
      <div className="wrap footer-grid">
        ...
        <div><h4>Mua sắm</h4><a href="/#products">Tất cả sản phẩm</a><a href="/compare">So sánh sản phẩm</a><a href="/cart">Giỏ hàng</a><a href="/register">Đăng ký thành viên</a><a href="/support">Trung tâm trợ giúp</a></div>
